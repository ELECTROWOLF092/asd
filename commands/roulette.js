...
.setColor("#FFFFFF")
.setDescription(`:cross: Specify an amount to gamble | m!roulette <color> <amount>`);

let moneymore = new Discord.RichEmbed()
.setColor("#FFFFFF")
.setDescription(`:cross: You are betting more than you have`);

let colorbad = new Discord.RichEmbed()
.setColor("#FFFFFF")
.setDescription(`:cross: Specify a color | Red [1.5x] Black [2x] Green [15x]`);
    ...
    if (random == 0 && colour == 2) { // Green
        ...
        .setColor("#FFFFFF")
        .setDescription(`:green_square:  You won ${money} coins\n\nMultiplier: 15x`);
        ...
        .setColor("#FFFFFF")
        .setDescription(`:cross: You lost ${money} coins\n\nMultiplier: 0x`);
